...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(109, 139, 232);
		
		// Select a map provider
		AbstractMapProvider provider1 = new Google.GoogleTerrainProvider();
		AbstractMapProvider provider2 = new MBTilesMapProvider(mbTilesString);
		// Set a zoom level
		int zoomLevel1 = 2;
		int zoomLevel2 = 10;
		...
		// zooming to my home location
		map2.zoomAndPanTo(zoomLevel2, new Location(43.7f, -79.3f));
		// Making the new map interactive
